...
ALTER TABLE "wallet" ADD CONSTRAINT "chk_both_deleted_at_and_by" CHECK (("deleted_at" IS NULL AND "deleter_id" IS NULL) OR ("deleted_at" IS NOT NULL AND "deleter_id" IS NOT NULL));
...
ALTER TABLE "category" ADD CONSTRAINT "chk_both_deleted_at_and_by" CHECK (("deleted_at" IS NULL AND "deleter_id" IS NULL) OR ("deleted_at" IS NOT NULL AND "deleter_id" IS NOT NULL));
...
ALTER TABLE "transaction" ADD CONSTRAINT "chk_both_deleted_at_and_by" CHECK (("deleted_at" IS NULL AND "deleter_id" IS NULL) OR ("deleted_at" IS NOT NULL AND "deleter_id" IS NOT NULL));